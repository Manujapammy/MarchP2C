...
export default function ProjectCompleted() {
    let anugrahaNilaya = [
        ...
        { img: 'images/pic7/anugraha3.jpg', name: "Praveen" },
        { img: 'images/pic7/anugraha1.jpg', name: "Papegowdas" },
        { img: 'images/pic7/anugraha2.jpg', name: "Bhagya" },
        { img: 'images/pic7/anugraha5.jpg', name: "Papegowdas" },
        { img: 'images/pic7/anugraha6.jpg', name: "Bhagya" }
    ];
